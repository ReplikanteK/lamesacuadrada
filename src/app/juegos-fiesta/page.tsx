  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FFFBEB] text-stone-900 antialiased">
      ...
      <article className="max-w-6xl mx-auto px-6 py-10 w-full">
        <div className="inline-flex items-center gap-2 text-xs font-bold tracking-wide uppercase bg-orange-600 text-white px-3 py-1.5 rounded-full mb-4 shadow-sm">● Fiesta 6+ • Actualizado Sep 2026</div>
