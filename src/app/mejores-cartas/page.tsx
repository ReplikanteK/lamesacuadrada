...
export const metadata: Metadata = {
  ...
  description: "Ranking juegos de cartas 2026: Trio As d'Or, 7 Wonders Duel, Jaipur, The Crew, Sushi Go Party, Splendor, Dobble y más. 15-40 min, caja pequeña, comparativa BGG y precio Amazon.",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FFFBEB] text-stone-900 antialiased">
      ...
      <article className="max-w-6xl mx-auto px-6 py-10 w-full">
        ...
        <p className="mt-4 text-lg leading-7 text-stone-600 max-w-2xl font-medium">Para quien quiere caja pequeña y mucha rejugabilidad. Draft, bazas, combos y farol en 15-40 min. Incluye Trio As d'Or 2024, 7 Wonders Duel, Jaipur y The Crew. Ordenados por BGG ★.</p>
