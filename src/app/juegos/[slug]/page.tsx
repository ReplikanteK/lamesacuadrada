...
export default async function GamePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FFFBEB] text-stone-900 antialiased">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Inicio", item: "https://lamesacuadrada.vercel.app/" }, { "@type": "ListItem", position: 2, name: "Juegos", item: "https://lamesacuadrada.vercel.app/#comparativa" }, { "@type": "ListItem", position: 3, name: game.name, item: `https://lamesacuadrada.vercel.app/juegos/${game.slug}` }] }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Product", name: game.name, brand: { "@type": "Brand", name: game.publisher }, image: `https://lamesacuadrada.vercel.app${game.imageUrl}`, description: detail.description, offers: { "@type": "Offer", price: game.price.replace("€","").replace(",","."), priceCurrency: "EUR", availability: "https://schema.org/InStock", url: game.amazonUrl, priceValidUntil: "2026-12-31", seller: { "@type": "Organization", name: "Amazon.es" }, hasMerchantReturnPolicy: { "@type": "MerchantReturnPolicy", applicableCountry: "ES", returnPolicyCategory: "https://schema.org/MerchantReturnFiniteWindow", merchantReturnDays: 30, returnMethod: "https://schema.org/ReturnByMail", returnFees: "https://schema.org/FreeReturn" }, shippingDetails: { "@type": "OfferShippingDetails", shippingRate: { "@type": "MonetaryAmount", value: 0, currency: "EUR" }, shippingDestination: { "@type": "DefinedRegion", addressCountry: "ES" }, deliveryTime: { "@type": "ShippingDeliveryTime", handlingTime: { "@type": "QuantitativeValue", minValue: 0, maxValue: 1, unitCode: "DAY" }, transitTime: { "@type": "QuantitativeValue", minValue: 1, maxValue: 3, unitCode: "DAY" } } } } }) }} />
